...
namespace Parents.Backend.Controllers.HealthManagement.Helpers
{
    ...
    public class UrgencySeveritiesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "UrgencySeverityId,UrgencySeverityDescription")] UrgencySeverity urgencySeverity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "UrgencySeverityId,UrgencySeverityDescription")] UrgencySeverity urgencySeverity)
        {
            if (ModelState.IsValid)
            {
