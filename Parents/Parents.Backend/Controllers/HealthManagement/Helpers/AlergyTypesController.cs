...
namespace Parents.Backend.Controllers.HealthManagement.Helpers
{
    ...
    public class AlergyTypesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "AlergyTypeId,AlergyTypeDescriptiom,AlergyTypeCharacteristics")] AlergyType alergyType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "AlergyTypeId,AlergyTypeDescriptiom,AlergyTypeCharacteristics")] AlergyType alergyType)
        {
            if (ModelState.IsValid)
            {
