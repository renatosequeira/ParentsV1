...
namespace Parents.Backend.Controllers.HealthManagement.Helpers
{
    ...
    public class MedicalInstitutionsPController : Controller
    {
        ...
        public async Task<ActionResult> Create(MedicalInstitutions medicalInstitutions)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit(MedicalInstitutions medicalInstitutions)
        {
            if (ModelState.IsValid)
            {
