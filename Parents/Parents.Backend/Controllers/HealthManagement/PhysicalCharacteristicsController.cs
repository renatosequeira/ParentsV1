...
namespace Parents.Backend.Controllers.HealthManagement
{
    ...
    public class PhysicalCharacteristicsController : Controller
    {
        ...
        public async Task<ActionResult> Create(PhysicalCharacteristic physicalCharacteristic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit(PhysicalCharacteristic physicalCharacteristic)
        {
            if (ModelState.IsValid)
            {
